" Python syntax file from https://github.com/vim-python/python-syntax (MIT License)
" See https://github.com/vim-python/python-syntax/blob/master/LICENSE for license details.
